        ...
        <div class="grid md:grid-cols-2 items-center gap-6 max-w-6xl w-full">
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              ...
              <div class="!mt-8">
                <button type="button" class="bg-blue-600 w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-lg text-white transition duration-200 hover:bg-white hover:text-black border-2 border-transparent hover:border-blue-600">
                  Sign in
                </button>
              </div>
